...
define('API_USERNAME', $DC_Product_Vendor->paypal_masspay->api_username);
//
...
define('API_PASSWORD', $DC_Product_Vendor->paypal_masspay->api_pass);

/**
# API_Signature:The Signature associated with the API user. which is generated by paypal.
*/

define('API_SIGNATURE', $DC_Product_Vendor->paypal_masspay->api_signature );

/**
# Endpoint: this is the server URL which you have to connect for submitting your API request.
*/
if($DC_Product_Vendor->paypal_masspay->test_mode) {
