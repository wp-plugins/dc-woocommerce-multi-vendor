...
/**
 * @class 		DC_Product_Vendor_Template
 * @version		1.0.0
...
class DC_Product_Vendor_Template {
	...
	public function locate_template($template_name, $template_path = '', $default_path = '') {
		...
		if (!$default_path)
			$default_path = $DC_Product_Vendor->plugin_path . 'templates/';
	...
	public function get_template_part($slug, $name = '') {
		...
		if (!$template && $name && file_exists($DC_Product_Vendor->plugin_path . "templates/{$slug}-{$name}.php"))
			$template = $DC_Product_Vendor->plugin_path . "templates/{$slug}-{$name}.php";
