                                  ...
                                  "sections" => array(
                                                      "default_settings_section" => array("title" =>  __('General Options -', $DC_Product_Vendor->text_domain), // Section one
                                                                                         "fields" => array("default_commission" => array('title' => __('Default commission (%)', $DC_Product_Vendor->text_domain), 'type' => 'text', 'id' => 'default_commission', 'label_for' => 'default_commission', 'name' => 'default_commission', 'hints' => __('This will be the default commssion(in percentage) paid to vendors if product and vendor specific commission is not set. ', $DC_Product_Vendor->text_domain)), // Text
                                                                                                           ...
                                                                                                           "catalog_colorpicker" => array('title' => __('Vendor Name label color', $DC_Demo_Plugin->text_domain), 'type' => 'colorpicker', 'id' => 'catalog_colorpicker', 'label_for' => 'catalog_colorpicker', 'name' => 'catalog_colorpicker', 'default' => '000000', 'hints' => __('Vendor Name label color in shop page and single product page', $DC_Product_Vendor->text_domain)), // Colorpicker
                                                                                                           "catalog_hover_colorpicker" => array('title' => __('Vendor Name label color(on hover)', $DC_Demo_Plugin->text_domain), 'type' => 'colorpicker', 'id' => 'catalog_hover_colorpicker', 'label_for' => 'catalog_hover_colorpicker', 'name' => 'catalog_hover_colorpicker', 'default' => '000000', 'hints' => __('Vendor Name label color on hover in shop page and single product page', $DC_Product_Vendor->text_domain)), // Colorpicker
